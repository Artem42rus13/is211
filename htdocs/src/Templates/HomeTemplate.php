...
class HomeTemplate extends BaseTemplate {
    public function getHomeTemplate(): string 
    {
        ...
        <div id="carouselExample" class="carousel slide">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/Shashlyk-shejha.jpg" class="d-block w-100 h-100" alt="1">
            </div>
            <div class="carousel-item">
              <img src="./img/Shaurma-muzhskaya.png" class="d-block w-100 h-100" alt="3">
            </div>
            <div class="carousel-item">
              <img src="./img/Shaurma-carskaya.png" class="d-block w-100 h-100" alt="2">
            </div>
          </div>
        ...
        <div class="row mt-5">
            <p>
                Приглашаем в наше онлайн-кафе "Грилька"!
            </p>
            <p>
